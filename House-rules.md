...
## Be Kind  
“Roleplaying” isn’t an excuse for unkindness. In-character or out, be respectful.

## Engage: Listen, Watch, Speak  
Stay present and support each other’s stories. Speak in-character for roleplay and out-of-character for tactics. Encourage interaction between characters, not just with the DM.

## Roleplay in First Person  
Say “I do this,” not “my guy does this.” Voice acting is optional, but first-person adds immersion.

## Be on Time  
Arrive early, be ready, and have your character prepped before game time.

## Limit Language  
Keep profanity low and avoid real-world politics or religion at the table.

## Respect Theater of the Mind  
Don't move tokens without DM approval. Let narration lead. Some areas may be off-map — stay flexible and follow the DM’s cues to preserve immersion and continuity.

## Avoid Metagaming  
Play what your character knows. Share info character-to-character to reduce meta decisions and keep it fun.

## Know Your Character  
Understand your abilities and have go-to strategies. Spellcasters should review [chapter 10](https://www.dndbeyond.com/sources/basic-rules/spellcasting). Even simple characters benefit from prep.

## Play Efficiently  
Have a plan on your turn. Use AboveVTT tools to streamline rolls and actions. Ask for help if needed — I’m happy to assist with setup and shortcuts.
...
* One creature/obstacle = [Half Cover](https://www.dndbeyond.com/sources/dnd/basic-rules-2014/combat#Cover)
* Over half blocked = [Three-Quarters Cover](https://www.dndbeyond.com/sources/dnd/basic-rules-2014/combat#Cover)
* No line of sight = [Total Cover](https://www.dndbeyond.com/sources/dnd/basic-rules-2014/combat#Cover)
* Only the best cover applies

**Diagonals:**
[DMG optional rule](https://www.dndbeyond.com/sources/dnd/dmg-2014/running-the-game#OptionalRuleDiagonals): first = 5 ft, second = 10 ft, alternating — prevents AoE distortion.

**Elevation:**
Use horizontal + half vertical (rounded down).

**Split Movement:**
You can always split movement, even between attacks or actions if the rules allow it.

**Flanking = Advantage:**
[DMG variant](https://www.dndbeyond.com/sources/dnd/dmg-2014/running-the-game#OptionalRuleFlanking): you and an ally on opposite sides = **advantage**.

**Difficult Terrain:**
Costs double movement unless ignored. If it looks rough, ask.

**[Object Interactions](https://www.dndbeyond.com/sources/dnd/basic-rules-2014/combat#OtherActivityonYourTurn):**
...
**Tiered Attacks:**
If your attack roll misses a creature (except a natural 1), you can deal damage to that creature equal to the ability modifier you used to make the attack roll. This damage is the same type dealt by the weapon, and the damage can be increased only by increasing the ability modifier. If your attack roll exceeds 15, but is less than the target's AC, you deal one half damage. 
...
[**Skill Checks:**](https://www.dndbeyond.com/sources/dnd/phb-2014/using-ability-scores#AbilityChecks) 
Players describe actions, and the DM narrates outcomes or calls for a check. Good narration can bypass rolling.

**Skills & Tools:**
-   Proficiency = add bonus
    
-   Two or more relevant proficiencies = roll with advantage

**Surprise and Hiding:** 
The first person to break line of sight with an enemy achieves [**surprise**](https://www.dndbeyond.com/sources/dnd/basic-rules-2014/combat#Surprise) if their Dexterity (Stealth) check beats the enemy's Passive Perception. 

Otherwise, when hiding, a Stealth roll is only required **when the DM asks for it**. Visibility, noise, and distraction determine success.

Enemies hide too...

**Traps, Locks and Secrets:**
-   _Perception_ = notice something
    
-   _Investigation_ or _Arcana*_ = understand or figure it out
...
-   In combat: limited to beasts you’ve encountered or included in your curated list
    

**Conjure Spells (Animals, Elementals, etc.):**
-   Choose: 1 CR2, 2 CR½, 3 CR¼, or 4 CR⅛ from your curated list
    
-   Upcasting doesn't increase count
    
-   6th level: attacks count as magical
    
-   8th level: gain resistance to non-magical B/P/S
    

**Curated Lists:**  
Work with the DM to pre-select summons or shapes. Add them to your Extras tab in D&D Beyond for fast access.
...
-   **Track only** items with significant cost.
    
-   Standard **encumbrance rules** apply.
    
-   A typical encounter = ~1 minute. Searching or studying = ~5 minutes, based on narrative.
...
Hit points are not meat. They're energy, grit, luck, stamina — and they come back with time, breath, and resolve.
...
[**Readied Actions:**](https://www.dndbeyond.com/sources/dnd/phb-2014/combat#Ready)  
Readied actions allow you to defer your turn, not just perform a single action.

As normal, you declare a trigger (e.g., “when an enemy enters my reach”).

If that trigger occurs, you may resume your turn, using any remaining actions, bonus actions, or movement you haven't yet spent.
...
Readied Actions can interrupt casters and force Concentration saves.
