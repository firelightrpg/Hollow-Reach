...
**Please set your display name in discord to (player/ character).** For example, my name is John and if I was playing Tordek, a dwarven champion, I would set my display name to **John/Tordek**. This just helps the DM correlate the player names with the character names and determine who’s speaking or acting. If you are unsure how to do this, see [discord server nickname](https://support.discord.com/hc/en-us/articles/219070107-Server-Nicknames#:~:text=If%20you're%20on%20the,new%20nickname%20of%20your%20choice!).
